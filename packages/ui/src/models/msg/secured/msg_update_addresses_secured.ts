...
class MsgUpdateAddressesSecured {
  ...
  constructor(payload: object) {
    this.category = 'update_addresses_secured';
  ...
  static fromJson(json: object, log?: Log): MsgUpdateAddressesSecured {
    const instance = {
      category: 'update_addresses_secured',
      json,
...
export default MsgUpdateAddressesSecured;
