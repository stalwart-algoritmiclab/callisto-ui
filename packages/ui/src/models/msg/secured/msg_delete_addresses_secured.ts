...
class MsgDeleteAddressesSecured {
  ...
  constructor(payload: object) {
    this.category = 'delete_addresses_secured';
  ...
  static fromJson(json: object, log?: Log): MsgDeleteAddressesSecured {
    const instance = {
      category: 'delete_addresses_secured',
      json,
...
export default MsgDeleteAddressesSecured;
