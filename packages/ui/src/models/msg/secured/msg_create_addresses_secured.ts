...
class MsgCreateAddressesSecured {
  ...
  constructor(payload: object) {
    this.category = 'create_addresses_secured';
  ...
  static fromJson(json: object, log?: Log): MsgCreateAddressesSecured {
    const instance = {
      category: 'create_addresses_secured',
      json,
...
export default MsgCreateAddressesSecured;
