...
class MsgDeleteTariffs {
  ...
  static fromJson(json: object, log?: Log): MsgDeleteTariffs {
    const instance = {
      category: 'delete_tarrifs',
      json,
...
export default MsgDeleteTariffs;
