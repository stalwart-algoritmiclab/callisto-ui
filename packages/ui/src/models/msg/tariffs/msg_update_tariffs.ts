...
class MsgUpdateTariffs {
  ...
  static fromJson(json: object, log?: Log): MsgUpdateTariffs {
    const instance = {
      category: 'update_tarrifs',
      json,
...
export default MsgUpdateTariffs;
