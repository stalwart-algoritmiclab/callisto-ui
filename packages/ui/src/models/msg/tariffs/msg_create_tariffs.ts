...
class MsgCreateTariffs {
  ...
  static fromJson(json: object, log?: Log): MsgCreateTariffs {
    const instance = {
      category: 'create_tarrifs',
      json,
...
export default MsgCreateTariffs;
