...
class MsgDeleteAddresses {
  ...
  constructor(payload: object) {
    this.category = 'delete_addresses';
  ...
  static fromJson(json: object, log?: Log): MsgDeleteAddresses {
    const instance = {
      category: 'delete_addresses',
      json,
...
export default MsgDeleteAddresses;
