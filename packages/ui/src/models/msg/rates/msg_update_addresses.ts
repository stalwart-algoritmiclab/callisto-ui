...
class MsgUpdateAddresses {
  ...
  constructor(payload: object) {
    this.category = 'update_addresses';
  ...
  static fromJson(json: object, log?: Log): MsgUpdateAddresses {
    const instance = {
      category: 'update_addresses',
      json,
...
export default MsgUpdateAddresses;
