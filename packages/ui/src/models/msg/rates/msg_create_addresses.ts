...
class MsgCreateAddresses {
  ...
  constructor(payload: object) {
    this.category = 'create_addresses';
  ...
  static fromJson(json: object, log?: Log): MsgCreateAddresses {
    const instance = {
      category: 'create_addresses',
      json,
...
export default MsgCreateAddresses;
