...
export const convertCoinFromCustomDecimal = (num: string, decimal: string) => {
  return numeral(num)
    .divide(Math.pow(10, Number(decimal)))
    .value();
};
...
export const convertCoinToCustomDecimal = (num: string, decimal: string) => {
  return numeral(num)
