...
export { default as Exchange } from '@/components/msg/exchange';
export { default as Faucet } from '@/components/msg/faucet';
export { default as CreateTariffs } from '@/components/msg/tariffs/create_tariffs';
