...
import { MsgUpdateAddressesSecured } from '@/models';
...
const UpdateAddressesSecured: FC<{ message: MsgUpdateAddressesSecured }> = (props: any) => {
  ...
  return (
    <Typography>
      <AppTrans
        i18nKey="message_contents:txUpdateAddressSecureContent"
        components={[
...
export default UpdateAddressesSecured;
