...
ARG NEXT_PUBLIC_API_COSMOS
ENV NEXT_PUBLIC_API_COSMOS=${NEXT_PUBLIC_API_COSMOS}
ARG NEXT_PUBLIC_WS_TENDERMINT
ENV NEXT_PUBLIC_WS_TENDERMINT=${NEXT_PUBLIC_WS_TENDERMINT}
ARG NEXT_PUBLIC_DECIMAL
ENV NEXT_PUBLIC_DECIMAL=${NEXT_PUBLIC_DECIMAL}
ARG NEXT_PUBLIC_EXCHANGE_MODULE_ADDRESS
ENV NEXT_PUBLIC_EXCHANGE_MODULE_ADDRESS=${NEXT_PUBLIC_EXCHANGE_MODULE_ADDRESS}
